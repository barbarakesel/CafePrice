...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"1 - ATESY Êîìàíäîğ-4İ-Ò : 940$\r\n\r\n\r\n2 - GASTRORAG EL-280 : 510$\r\n\r\n\r\n3 - Hurakan "
				L"HKN-PEG550R : 1150$\r\n\r\n\r\n4 - ÈÏÃ-140164 : 805$";
			// 
			// button1
			// 
			...
			this->âûéòèÈçÏğîãğàììûToolStripMenuItem->Click += gcnew System::EventHandler(this, &grill::âûéòèÈçÏğîãğàììûToolStripMenuItem_Click);
			// 
			...
			this->ïîñìîòğåòüÊàòàëîãToolStripMenuItem->Click += gcnew System::EventHandler(this, &grill::ïîñìîòğåòüÊàòàëîãToolStripMenuItem_Click);
			// 
			...
			this->âÃëàâíîåÌåíşToolStripMenuItem->Click += gcnew System::EventHandler(this, &grill::âÃëàâíîåÌåíşToolStripMenuItem_Click);
			// 
			...
			this->âĞåäàêòîğToolStripMenuItem->Click += gcnew System::EventHandler(this, &grill::âĞåäàêòîğToolStripMenuItem_Click);
			// 
			// grill
			// 
