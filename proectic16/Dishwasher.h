...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->âûéòèÈçÏğîãğàììûToolStripMenuItem->Click += gcnew System::EventHandler(this, &Dishwasher::âûéòèÈçÏğîãğàììûToolStripMenuItem_Click);
			// 
			...
			this->ïîñìîòğåòüÊàòàëîãToolStripMenuItem->Click += gcnew System::EventHandler(this, &Dishwasher::ïîñìîòğåòüÊàòàëîãToolStripMenuItem_Click);
			// 
			...
			this->âÃëàâíîåÌåíşToolStripMenuItem->Click += gcnew System::EventHandler(this, &Dishwasher::âÃëàâíîåÌåíşToolStripMenuItem_Click);
			// 
			...
			this->âĞåäàêòîğToolStripMenuItem->Click += gcnew System::EventHandler(this, &Dishwasher::âĞåäàêòîğToolStripMenuItem_Click);
			// 
			// comboBox1
			// 
