...
namespace proectic16 {
	...
	/// Ñâîäêà äëÿ Fridge
	/// </summary>
	public ref class Fridge : public System::Windows::Forms::Form
	{
	public:
		Fridge(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(288, 250);
			this->label1->TabIndex = 0;
			this->label1->Text = L"1 - Alpicool CR65 : 750$\r\n\r\n\r\n2 - BBK RF-068 : 240$\r\n\r\n\r\n3 - Nord NR 403 B : 300$"
				L"\r\n\r\n\r\n4 - SonataQua 1200LED : 500$";
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(30, 330);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(281, 66);
			this->button1->TabIndex = 1;
			this->button1->Text = L"âåğíóòüñÿ â ğåäàêòîğ";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Fridge::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(418, 32);
			...
			this->button2->Click += gcnew System::EventHandler(this, &Fridge::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button3->Location = System::Drawing::Point(418, 104);
			...
			this->button3->Click += gcnew System::EventHandler(this, &Fridge::button3_Click);
			// 
			// button4
			// 
			...
			this->button4->Location = System::Drawing::Point(418, 176);
			...
			this->button4->Click += gcnew System::EventHandler(this, &Fridge::button4_Click);
			// 
			// button5
			// 
			...
			this->button5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button5->Location = System::Drawing::Point(418, 248);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(90, 66);
			this->button5->TabIndex = 5;
			this->button5->Text = L"êóïèòü";
			this->button5->UseMnemonic = false;
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &Fridge::button5_Click);
			// 
			// menuStrip1
			// 
			...
			this->âûéòèÈçÏğîãğàììûToolStripMenuItem->Click += gcnew System::EventHandler(this, &Fridge::âûéòèÈçÏğîãğàììûToolStripMenuItem_Click);
			// 
			...
			this->ïîñìîòğåòüÊàòàëîãToolStripMenuItem->Click += gcnew System::EventHandler(this, &Fridge::ïîñìîòğåòüÊàòàëîãToolStripMenuItem_Click);
			// 
			...
			this->âÃëàâíîåÌåíşToolStripMenuItem->Click += gcnew System::EventHandler(this, &Fridge::âÃëàâíîåÌåíşToolStripMenuItem_Click);
			// 
			...
			this->âĞåäàêòîğToolStripMenuItem->Click += gcnew System::EventHandler(this, &Fridge::âĞåäàêòîğToolStripMenuItem_Click);
			// 
			// comboBox1
			// 
			...
			this->comboBox1->Location = System::Drawing::Point(345, 44);
			this->comboBox1->Name = L"comboBox1";
			this->comboBox1->Size = System::Drawing::Size(58, 39);
			this->comboBox1->TabIndex = 8;
			this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &Fridge::comboBox1_SelectedIndexChanged);
			// 
			// comboBox2
			// 
			...
			this->comboBox2->Location = System::Drawing::Point(345, 116);
			this->comboBox2->Name = L"comboBox2";
			this->comboBox2->Size = System::Drawing::Size(58, 39);
			this->comboBox2->TabIndex = 9;
			this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &Fridge::comboBox2_SelectedIndexChanged);
			// 
			// comboBox3
			// 
			...
			this->comboBox3->Location = System::Drawing::Point(345, 188);
			this->comboBox3->Name = L"comboBox3";
			this->comboBox3->Size = System::Drawing::Size(58, 39);
			this->comboBox3->TabIndex = 10;
			this->comboBox3->SelectedIndexChanged += gcnew System::EventHandler(this, &Fridge::comboBox3_SelectedIndexChanged);
			// 
			// comboBox4
			// 
			...
			this->comboBox4->Location = System::Drawing::Point(345, 264);
			this->comboBox4->Name = L"comboBox4";
			this->comboBox4->Size = System::Drawing::Size(58, 39);
			this->comboBox4->TabIndex = 11;
			this->comboBox4->SelectedIndexChanged += gcnew System::EventHandler(this, &Fridge::comboBox4_SelectedIndexChanged);
			// 
			// Fridge
			// 
			...
			this->Load += gcnew System::EventHandler(this, &Fridge::Fridge_Load);
...
private: System::Void Fridge_Load(System::Object^ sender, System::EventArgs^ e){}
