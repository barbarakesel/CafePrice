...
namespace proectic16 {
	...
	/// Ñâîäêà äëÿ postavka
	/// </summary>
	public ref class postavka : public System::Windows::Forms::Form
	{
	public:
		postavka(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(179, 250);
			this->label1->TabIndex = 0;
			this->label1->Text = L"1 - ProStore : 200$\r\n\r\n\r\n2 - Åâğîîïò : 100$\r\n\r\n\r\n3 - Êîïåå÷êà : 70$\r\n\r\n\r\n4 - Êîğî"
				L"íà : 150$";
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(31, 323);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(281, 66);
			this->button1->TabIndex = 1;
			this->button1->Text = L"âåğíóòüñÿ â ğåäàêòîğ";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &postavka::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(404, 31);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(90, 66);
			this->button2->TabIndex = 2;
			this->button2->Text = L"êóïèòü";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &postavka::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button3->Location = System::Drawing::Point(404, 103);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(90, 66);
			this->button3->TabIndex = 3;
			this->button3->Text = L"êóïèòü";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &postavka::button3_Click);
			// 
			// button4
			// 
			...
			this->button4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button4->Location = System::Drawing::Point(404, 175);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(90, 66);
			this->button4->TabIndex = 4;
			this->button4->Text = L"êóïèòü";
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &postavka::button4_Click);
			// 
			// button5
			// 
			...
			this->button5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button5->Location = System::Drawing::Point(404, 247);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(90, 66);
			this->button5->TabIndex = 5;
			this->button5->Text = L"êóïèòü";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &postavka::button5_Click);
			// 
			// comboBox1
			// 
			...
			this->comboBox1->Location = System::Drawing::Point(318, 52);
			this->comboBox1->Name = L"comboBox1";
			this->comboBox1->Size = System::Drawing::Size(58, 24);
			this->comboBox1->TabIndex = 8;
			this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &postavka::comboBox1_SelectedIndexChanged);
			// 
			// comboBox2
			// 
			...
			this->comboBox2->Location = System::Drawing::Point(318, 128);
			this->comboBox2->Name = L"comboBox2";
			this->comboBox2->Size = System::Drawing::Size(58, 24);
			this->comboBox2->TabIndex = 9;
			this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &postavka::comboBox2_SelectedIndexChanged);
			// 
			// comboBox3
			// 
			...
			this->comboBox3->Location = System::Drawing::Point(318, 200);
			this->comboBox3->Name = L"comboBox3";
			this->comboBox3->Size = System::Drawing::Size(58, 24);
			this->comboBox3->TabIndex = 10;
			this->comboBox3->SelectedIndexChanged += gcnew System::EventHandler(this, &postavka::comboBox3_SelectedIndexChanged);
			// 
			// comboBox4
			// 
			...
			this->comboBox4->Location = System::Drawing::Point(318, 272);
			this->comboBox4->Name = L"comboBox4";
			this->comboBox4->Size = System::Drawing::Size(58, 24);
			this->comboBox4->TabIndex = 11;
			this->comboBox4->SelectedIndexChanged += gcnew System::EventHandler(this, &postavka::comboBox4_SelectedIndexChanged);
			// 
			// menuStrip1
			// 
			...
			this->ìåíşToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->âûéòèÈçÏğîãğàììûToolStripMenuItem,
					this->ïîñìîòğåòüÊàòàëîãToolStripMenuItem, this->âĞåäàêòîğToolStripMenuItem, this->âÃëàâíîåÌåíşToolStripMenuItem
			});
			...
			this->âûéòèÈçÏğîãğàììûToolStripMenuItem->Click += gcnew System::EventHandler(this, &postavka::âûéòèÈçÏğîãğàììûToolStripMenuItem_Click);
			// 
			...
			this->ïîñìîòğåòüÊàòàëîãToolStripMenuItem->Click += gcnew System::EventHandler(this, &postavka::ïîñìîòğåòüÊàòàëîãToolStripMenuItem_Click);
			// 
			...
			this->âĞåäàêòîğToolStripMenuItem->Click += gcnew System::EventHandler(this, &postavka::âĞåäàêòîğToolStripMenuItem_Click);
			// 
			...
			this->âÃëàâíîåÌåíşToolStripMenuItem->Click += gcnew System::EventHandler(this, &postavka::âÃëàâíîåÌåíşToolStripMenuItem_Click);
			// 
			// postavka
			// 
			...
			this->Name = L"postavka";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"postavka";
			this->Load += gcnew System::EventHandler(this, &postavka::postavka_Load);
...
private: System::Void postavka_Load(System::Object^ sender, System::EventArgs^ e) {
}
};
}
